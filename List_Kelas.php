...
<div class="container">
		<div class="row">
			<div class="col-lg-4">
				<h3 style="color:#66ccff;">Daftar Kelas</h3>
				<a href="Form_Kelas.php">Tambah Data</a>
			</div>	
			<div class="col-lg-10">
      ...
      include_once('fix_mysql.inc.php');
			...
			$query = mysql_query("SELECT * FROM Kelas ORDER BY id_kelas");
			//echo "<table border=1 >";
			//echo "<tr><td colspan=7>Filter Jenis :  
			echo "</br>";
			echo "<tr bgcolor=#AAAAAA><th>ID. Kelas</th><th>Nama Kelas</th><th>Wali Kelas</th><th>Ruang</th>
			<th>Delete/Edit</th></tr>";
				while($brs = mysql_fetch_assoc($query)){
				echo "<tr><td>$brs[id_kelas]</td><td>$brs[nama_kelas]</td><td>$brs[wali_kelas]</td><td>$brs[ruang]</td>
				<td>
					<a href='Hapus_Kelas.php?id_kelas=$brs[id_kelas]'>Delete</a>
					/
					<a href='Edit_Kelas.php?id_kelas=$brs[id_kelas]'>Edit</a>
				</td></tr>";
			}
			echo "</table>";
			?>
